...
namespace NetCoreDemo.Controllers
{
    public class NhanVienController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NhanVienId,TenNhanVien")] NhanVien nhanVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NhanVienId,TenNhanVien")] NhanVien nhanVien)
        {
